...
public class Pozicanie extends JDialog {
	...
	private JButton btnPridajZakaznika = new JButton("Pridaj Zákazníka");
	private JButton okButton = new JButton("OK");
	private JButton cancelButton = new JButton("Cancel");
	
	private JLabel label = new JLabel("Kategória");
	private JLabel label_1 = new JLabel("Platforma");
	private JLabel label_2 = new JLabel("Vývojár");
	private JLabel label_3 = new JLabel("Vydávate¾");
	private JLabel label_4 = new JLabel("Rok vydania");
	private JLabel label_5 = new JLabel("Názov");
	private JLabel lblZakaznik = new JLabel("Zákazník");
